...
- **Manager visibility** — on Update Referrals a manager sees candidates referred *for* their department (workable) **and** referrals their department's people sent to other departments (view-only, with points earned — the hiring department owns the stage moves). Reporting has two views — "Candidates for…" a department, or "Referred by the team in…" a department — and every manager can pick any department or company-wide. Team matching uses each referrer's *current* department.
